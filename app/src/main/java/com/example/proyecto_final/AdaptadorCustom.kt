...
class AdaptadorCustom(items:ArrayList<Registro>, var listener:ClickListener, var longClickListener:LongClickListener): RecyclerView.Adapter<AdaptadorCustom.ViewHolder>() {
    ...
    class ViewHolder(vista: View, listener: ClickListener, longClickListener: LongClickListener): RecyclerView.Adapter<AdaptadorCustom.ViewHolder>(){
        ...
        override fun onClick(v: View?){
            this.listener?.onClick(v!!, adapterPositio)
        }
